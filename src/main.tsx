...
createRoot(root).render(<StrictMode><WorkspaceProvider><AgentsProvider><CanvasProvider><ChatProvider codexService={codexService}><App/></ChatProvider></CanvasProvider></AgentsProvider></WorkspaceProvider></StrictMode>);
